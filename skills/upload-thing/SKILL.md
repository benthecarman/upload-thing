---
name: upload-thing
description: Upload and share build artifacts, HTML pages, reports, or other files through either a public URL or a private URL protected by Cloudflare Access. Use when the user needs a downloadable or viewable file.
---
